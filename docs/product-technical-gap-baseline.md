...
| G-08 | P1 | No PostgreSQL hot-partition, retention, or production rollback evidence | PRs #4–#9 provide 3NF tables, composite tenant FKs, RLS, and embedded migrations; PR #16 verifies exact catalog RLS/index invariants; the recovery rehearsal preserves a 900/100 tenant distribution through dump/restore and applies the forward correlation-index migration | Production-shaped migration, RLS, load, retention, and rollback evidence | Measure load, vacuum, query plans, and tenant skew before choosing partitioning, retention, or rollback procedures |

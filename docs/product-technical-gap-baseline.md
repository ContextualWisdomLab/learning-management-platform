...
| G-08 | P1 | No PostgreSQL hot-partition, retention, or rollback evidence | PRs #4–#9 provide 3NF tables, composite tenant FKs, RLS, and one embedded migration; PR #16 verifies exact catalog RLS/index invariants and records the unimplemented retention/rollback boundary | Migration, RLS, load, retention, and rollback evidence | Run disposable backup/restore and forward-migration rehearsal with measured tenant skew |
...
3. Issue #3: stack the external-learner vertical on that foundation; PR #5 covers registration, PR #6 affiliation, PR #7 launch/progress, PR #8 completion persistence, PR #9 credential issuance, PR #10 credential revocation, PR #11 assessment-result reference handoff, PR #12 retry/binding safety, PR #13 audit/provenance events, PR #14 correlation propagation, PR #15 audit export, PR #16 operational evidence, and PR #17 completion correction.

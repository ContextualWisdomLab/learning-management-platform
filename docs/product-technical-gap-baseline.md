...
| PR #12 (next stack, local branch) | Adds registration-bound evidence references and idempotent assessment import retries. | It is not yet a GitHub PR or merged product evidence. |

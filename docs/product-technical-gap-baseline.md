...
| PR #10 (next stack, local branch) | Adds idempotent tenant-safe credential revocation from the same exact registration and completion decision. | It is not yet a GitHub PR or merged product evidence. |

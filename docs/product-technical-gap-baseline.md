...
| G-07 | P1 | No provenance, audit, or operational evidence | PR #13 adds tenant-isolated append-only audit events; PR #14 propagates optional caller correlation UUIDs while retaining generated IDs | Correlation-linked audit and decision history with export | Add audit export and operational receipts |
